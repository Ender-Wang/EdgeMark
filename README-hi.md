...
- 📁 Finder-जैसा ड्रैग-एंड-ड्रॉप ऑर्गनाइज़ेशन — नोट्स को फ़ोल्डर में, फ़ोल्डर को दूसरे फ़ोल्डर में, या एक नोट को दूसरे नोट पर खींचकर उन्हें नए फ़ोल्डर में समूहित करें; अमान्य ड्रॉप अस्वीकार किए जाते हैं, नाम टकराव के लिए मौजूदा अलर्ट आते हैं और कर्सर के साथ छोटा प्रीव्यू दिखता है
