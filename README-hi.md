...
- 📋 `⇧⌘C` पाथ कॉपी करें — चुने गए नोट्स, फ़ोल्डरों या मिश्रित चयन के absolute paths को हर पंक्ति में एक path के रूप में कॉपी करें; कोई पंक्ति चयनित न होने पर कुछ नहीं होता
